...
<a name="ajax"></a>Ajax
====================
> Esta serie de vídeos muestra las características nuevas en ASP.NET 4 para compatibilidad con JavaScript y jQuery.


- [Sintaxis imperativa de JavaScript para los controles del lado del cliente de Microsoft](aspnet-4-quick-hit-imperative-javascript-syntax-for-microsoft-client-side-controls.md)

...
---
# <a name="how-do-i-working-with-visual-studio-2008-net-framework"></a>[Cómo:] Trabajar con Visual Studio 2008 .NET Framework

por Asli Bilgin

En este vídeo se muestra cómo usar Visual Studio 2008 para trabajar con varias versiones de .NET Framework. Esto se conoce como compatibilidad con múltiples versiones. También trataremos nuevas plantillas en Visual Studio 2008.

[&#9654;Ver vídeo (4 minutos)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-working-with-visual-studio-2008-net-framework)

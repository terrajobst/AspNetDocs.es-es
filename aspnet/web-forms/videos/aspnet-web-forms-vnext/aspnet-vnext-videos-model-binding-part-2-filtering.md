...
---
# <a name="aspnet-vnext-videos-model-binding-part-2---filtering"></a>Vídeos de ASP.NET vNext: enlace de modelos, parte 2: filtrado

por [Damian Edwards](https://github.com/DamianEdwards)

En este vídeo, Damian Edwards continúa la demostración del enlace de modelos mediante la explicación del filtrado.

[&#9654;Ver vídeo (1 minuto)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-vnext-videos-model-binding-part-2-filtering)

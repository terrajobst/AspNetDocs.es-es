...
---
# <a name="aspnet-vnext-videos-model-binding-part-2---filtering"></a>Vídeos ASP.NET vNext: Enlace de modelos, parte 2: Filtrar

por [Damian Edwards](https://github.com/DamianEdwards)

En este vídeo, Damian Edwards continúa la demostración de enlace de modelos mediante la explicación de filtrado.

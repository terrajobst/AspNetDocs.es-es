...
---
# <a name="aspnet-vnext-videos-strongly-typed-data-controls"></a>Vídeos ASP.NET vNext: Controles de datos fuertemente tipados

por [Damian Edwards](https://github.com/DamianEdwards)

En este vídeo, Damian Edwards muestra controles de datos fuertemente tipados en Visual Studio vNext, que proporcionan IntelliSense y comprobación en tiempo de compilación.

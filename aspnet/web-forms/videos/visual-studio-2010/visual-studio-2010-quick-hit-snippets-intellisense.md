...
---
# <a name="visual-studio-2010-quick-hit---snippets-intellisense"></a>Visual Studio 2010 "Quick hit": fragmentos de código IntelliSense

por [Joe Stagner](https://github.com/JoeStagner)

En este vídeo, obtendrá información sobre la compatibilidad de los fragmentos de código HTML, ASP.NET y JavaScript en Visual Studio.

[&#9654;Ver vídeo (4 minutos)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/visual-studio-2010-quick-hit-snippets-intellisense)

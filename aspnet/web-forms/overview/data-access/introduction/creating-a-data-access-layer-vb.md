...
[![Crear un sitio Web de New File System-Based](creating-a-data-access-layer-vb/_static/image2.png)](creating-a-data-access-layer-vb/_static/image1.png)
...
[![ACódigo de acceso a datos es relegado a la capa DAL de ll](creating-a-data-access-layer-vb/_static/image6.png)](creating-a-data-access-layer-vb/_static/image5.png)
...
[![CElija Agregar un nuevo conjunto de datos a su proyecto](creating-a-data-access-layer-vb/_static/image9.png)](creating-a-data-access-layer-vb/_static/image8.png)
...
[![CElija la base de datos Northwind en la lista desplegable](creating-a-data-access-layer-vb/_static/image12.png)](creating-a-data-access-layer-vb/_static/image11.png)
...
[![Sguardar la cadena de conexión al archivo Web.config](creating-a-data-access-layer-vb/_static/image15.png)](creating-a-data-access-layer-vb/_static/image14.png)

**Figura 6**: Guardar la cadena de conexión a `Web.config` ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image16.png))
...
[![Qlos datos mediante una instrucción de SQL Ad-Hoc ulta](creating-a-data-access-layer-vb/_static/image18.png)](creating-a-data-access-layer-vb/_static/image17.png)
...
[![EEscriba el SQL Query en el cuadro de texto](creating-a-data-access-layer-vb/_static/image21.png)](creating-a-data-access-layer-vb/_static/image20.png)
...
[![Selegir solo las generar Insert, Update y Delete instrucciones opción](creating-a-data-access-layer-vb/_static/image27.png)](creating-a-data-access-layer-vb/_static/image26.png)

**Figura 10**: Seleccione solo las generar Insert, Update y Delete instrucciones opción ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image28.png))
...
[![Ccambiar el nombre del método GetData a GetProducts](creating-a-data-access-layer-vb/_static/image30.png)](creating-a-data-access-layer-vb/_static/image29.png)
...
[![Tse han agregado al conjunto de datos con tipo, productos de DataTable y ProductsTableAdapter](creating-a-data-access-layer-vb/_static/image33.png)](creating-a-data-access-layer-vb/_static/image32.png)
...
[![TLista de productos de él se muestra en un control GridView](creating-a-data-access-layer-vb/_static/image36.png)](creating-a-data-access-layer-vb/_static/image35.png)
...
[![CElija crear un Seleccionar instrucción que devuelve filas](creating-a-data-access-layer-vb/_static/image40.png)](creating-a-data-access-layer-vb/_static/image39.png)
...
[![EEscriba una consulta para devolver sólo los productos en una categoría especificada](creating-a-data-access-layer-vb/_static/image43.png)](creating-a-data-access-layer-vb/_static/image42.png)
...
[![CElija los nombres de los métodos de TableAdapter](creating-a-data-access-layer-vb/_static/image46.png)](creating-a-data-access-layer-vb/_static/image45.png)
...
[![Tse muestran aquellos productos pertenecientes a la categoría Bebidas](creating-a-data-access-layer-vb/_static/image50.png)](creating-a-data-access-layer-vb/_static/image49.png)

**Figura 19**: Se muestran la pertenencia de esos productos a la categoría bebidas ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image51.png))
...
[![Tse muestra los productos de la categoría Bebidas manguera](creating-a-data-access-layer-vb/_static/image53.png)](creating-a-data-access-layer-vb/_static/image52.png)
...
[![EACH Insert, Update y solicitud de eliminación se envía a la base de datos inmediatamente](creating-a-data-access-layer-vb/_static/image56.png)](creating-a-data-access-layer-vb/_static/image55.png)

**Figura 21**: Cada Insert, Update y Delete de solicitud se envían a la base de datos inmediatamente ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image57.png))
...
[![Ase invoca ll que cambios se sincronizan con la base de datos cuando el método de actualización](creating-a-data-access-layer-vb/_static/image59.png)](creating-a-data-access-layer-vb/_static/image58.png)
...
[![TTableAdapter tiene InsertCommand, UpdateCommand y DeleteCommand propiedades](creating-a-data-access-layer-vb/_static/image62.png)](creating-a-data-access-layer-vb/_static/image61.png)
...
**Figura 24**: Configurar la `INSERT`, `UPDATE`, y `DELETE` instrucciones en el generador de consultas ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image66.png))
...
[![Ccrear un método para agregar una nueva fila a la tabla Products](creating-a-data-access-layer-vb/_static/image68.png)](creating-a-data-access-layer-vb/_static/image67.png)
...
[![Augment la consulta para devolver el valor SCOPE_IDENTITY ()](creating-a-data-access-layer-vb/_static/image71.png)](creating-a-data-access-layer-vb/_static/image70.png)
...
[![Sel nombre del método nuevo a InsertProduct et](creating-a-data-access-layer-vb/_static/image74.png)](creating-a-data-access-layer-vb/_static/image73.png)
...
[![Cla propiedad ExecuteMode para escalar ambiar](creating-a-data-access-layer-vb/_static/image77.png)](creating-a-data-access-layer-vb/_static/image76.png)

**Figura 28**: Cambiar el `ExecuteMode` propiedad `Scalar` ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image78.png))
...
[![Ula instrucción SELECT para el método GetProducts() ctualización](creating-a-data-access-layer-vb/_static/image80.png)](creating-a-data-access-layer-vb/_static/image79.png)
...
[![Tél DataSet diseñador después de los cuatro TableAdapters se han agregado](creating-a-data-access-layer-vb/_static/image84.png)](creating-a-data-access-layer-vb/_static/image83.png)

**Figura 31**: El conjunto de datos diseñador después de los cuatro TableAdapters se han agregado ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image85.png))
...
[![Tque el archivo de definición de esquemas XML (XSD) del conjunto de datos Northwinds escrito](creating-a-data-access-layer-vb/_static/image87.png)](creating-a-data-access-layer-vb/_static/image86.png)

**Figura 32**: El archivo de definición de esquemas XML (XSD) del conjunto de datos Northwinds escrito ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image88.png))
...
[![TNombre de la compañía del proveedor aparece en la columna izquierda, sus productos en la derecha](creating-a-data-access-layer-vb/_static/image92.png)](creating-a-data-access-layer-vb/_static/image91.png)

**Figura 35**: Nombre de la compañía del proveedor aparece en la columna izquierda, sus productos en la derecha ([haga clic aquí para ver imagen en tamaño completo](creating-a-data-access-layer-vb/_static/image93.png))

...
[![TEdición de interfaz incluye DropDownLists y botones de opción de GridView](customizing-the-data-modification-interface-vb/_static/image2.png)](customizing-the-data-modification-interface-vb/_static/image1.png)
...
[![Cconfigurar el origen ObjectDataSource para usar el UpdateProduct sobrecargar acaba de crear](customizing-the-data-modification-interface-vb/_static/image5.png)](customizing-the-data-modification-interface-vb/_static/image4.png)
...
[![Rquitar los campos innecesarios del control GridView](customizing-the-data-modification-interface-vb/_static/image8.png)](customizing-the-data-modification-interface-vb/_static/image7.png)
...
[![TInterfaz de solo lectura de GridView completada](customizing-the-data-modification-interface-vb/_static/image11.png)](customizing-the-data-modification-interface-vb/_static/image10.png)
...
[![Rquitar el cuadro de texto y agregar un DropDownList para EditItemTemplate](customizing-the-data-modification-interface-vb/_static/image14.png)](customizing-the-data-modification-interface-vb/_static/image13.png)
...
[![Ccrear un Control de origen ObjectDataSource nuevo denominado CategoriesDataSource](customizing-the-data-modification-interface-vb/_static/image17.png)](customizing-the-data-modification-interface-vb/_static/image16.png)
...
[![BIND ObjectDataSource del CategoriesBLL GetCategories() método](customizing-the-data-modification-interface-vb/_static/image20.png)](customizing-the-data-modification-interface-vb/_static/image19.png)
...
[![Hguardar el campo CategoryName muestra y el CategoryID puede usar como el valor](customizing-the-data-modification-interface-vb/_static/image23.png)](customizing-the-data-modification-interface-vb/_static/image22.png)
...
[![Tel primer elemento de la lista desplegable se muestran de manera predeterminada](customizing-the-data-modification-interface-vb/_static/image26.png)](customizing-the-data-modification-interface-vb/_static/image25.png)
...
[![Bbuscar el CategoryID para la propiedad SelectedValue de DropDownList mediante enlace de datos bidireccional](customizing-the-data-modification-interface-vb/_static/image29.png)](customizing-the-data-modification-interface-vb/_static/image28.png)
...
[![TEditar producto categoría actual y los valores del proveedor se seleccionan de forma predeterminada](customizing-the-data-modification-interface-vb/_static/image32.png)](customizing-the-data-modification-interface-vb/_static/image31.png)
...
[![CElija (ninguno) para asignar un valor NULL para un producto de la categoría o proveedor](customizing-the-data-modification-interface-vb/_static/image35.png)](customizing-the-data-modification-interface-vb/_static/image34.png)
...
[![Add activo y no incluye opciones para RadioButtonList](customizing-the-data-modification-interface-vb/_static/image38.png)](customizing-the-data-modification-interface-vb/_static/image37.png)
...
[![Tél Discontinued casillas han sido reemplazados por pares de botón de Radio](customizing-the-data-modification-interface-vb/_static/image41.png)](customizing-the-data-modification-interface-vb/_static/image40.png)

...
[![EACH de los productos se muestran](paging-and-sorting-report-data-vb/_static/image7.png)](paging-and-sorting-report-data-vb/_static/image6.png)

**Figura 6**: Cada uno de los productos enumerados ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-vb/_static/image8.png))
...
[![Cla paginación de casilla de verificación Habilitar para agregar compatibilidad de paginación documentales](paging-and-sorting-report-data-vb/_static/image10.png)](paging-and-sorting-report-data-vb/_static/image9.png)
...
[![Wi-ésimo de paginación habilitado, solo un subconjunto de los registros se muestran a la vez](paging-and-sorting-report-data-vb/_static/image13.png)](paging-and-sorting-report-data-vb/_static/image12.png)

**Figura 8**: Con la paginación está habilitada, se muestran solo un subconjunto de los registros a la vez ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-vb/_static/image14.png))
...
[![Celectrónicamente con un número de página hace que una devolución de datos y muestra el subconjunto de registros adecuados](paging-and-sorting-report-data-vb/_static/image16.png)](paging-and-sorting-report-data-vb/_static/image15.png)
...
[![Tse muestran que el número de página actual y número Total de páginas](paging-and-sorting-report-data-vb/_static/image19.png)](paging-and-sorting-report-data-vb/_static/image18.png)

**Figura 10**: Se muestran el número de página actual y el número Total de páginas ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-vb/_static/image20.png))
...
[![TUsuario es dirigirá automáticamente a la sexta página al seleccionar el elemento de lista desplegable de página 6](paging-and-sorting-report-data-vb/_static/image22.png)](paging-and-sorting-report-data-vb/_static/image21.png)
...
[![Tque los resultados están ordenados por el precio unitario en orden ascendente](paging-and-sorting-report-data-vb/_static/image25.png)](paging-and-sorting-report-data-vb/_static/image24.png)
...
[![By quitar la propiedad SortExpression, ya No los usuarios pueden ordenar los productos por precio](paging-and-sorting-report-data-vb/_static/image29.png)](paging-and-sorting-report-data-vb/_static/image28.png)

**Figura 14**: Cuando se quita la propiedad SortExpression, los usuarios ya No pueden ordenar los productos por precio ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-vb/_static/image30.png))
...
[![Celectrónicamente con los productos desde el más caro al menos los pedidos de botón](paging-and-sorting-report-data-vb/_static/image32.png)](paging-and-sorting-report-data-vb/_static/image31.png)

...
title: Registrar detalles de error con ELMAH (VB) | Microsoft Docs
...
ms.locfileid: "74622262"
---
# <a name="logging-error-details-with-elmah-vb"></a>Registrar detalles de error con ELMAH (VB)

por [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Descargar código](https://download.microsoft.com/download/1/0/C/10CC829F-A808-4302-97D3-59989B8F9C01/ASPNET_Hosting_Tutorial_14_VB.zip) o [Descargar PDF](https://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial14_ELMAH_vb.pdf)
...
([Haga clic para ver la imagen de tamaño completo](logging-error-details-with-elmah-vb/_static/image7.png))
...
([Haga clic para ver la imagen de tamaño completo](logging-error-details-with-elmah-vb/_static/image10.png))
...
([Haga clic para ver la imagen de tamaño completo](logging-error-details-with-elmah-vb/_static/image13.png))
...
([Haga clic para ver la imagen de tamaño completo](logging-error-details-with-elmah-vb/_static/image16.png))
...
([Haga clic para ver la imagen de tamaño completo](logging-error-details-with-elmah-vb/_static/image19.png))
...
([Haga clic para ver la imagen de tamaño completo](logging-error-details-with-elmah-vb/_static/image22.png))

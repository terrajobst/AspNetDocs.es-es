...
[![TEventos de canalización de ASP.NET para un autenticado usuario al utilizar autenticación de formularios y Roles de Framework](role-based-authorization-vb/_static/image2.png)](role-based-authorization-vb/_static/image1.png)
...
[![TInformación de roles del usuario se puede almacenar en una Cookie para mejorar el rendimiento](role-based-authorization-vb/_static/image5.png)](role-based-authorization-vb/_static/image4.png)
...
[![Aun archivo Web.config en el directorio Roles dd](role-based-authorization-vb/_static/image8.png)](role-based-authorization-vb/_static/image7.png)
...
[![Osolo los usuarios del rol de los administradores puede ver las páginas protegidas](role-based-authorization-vb/_static/image11.png)](role-based-authorization-vb/_static/image10.png)
...
[![TGil puede visitar el UsersAndRoles.aspx página porque es de la función Administrators](role-based-authorization-vb/_static/image14.png)](role-based-authorization-vb/_static/image13.png)
...
[![TCampos puede ser configurado mediante el cuadro de GridView de diálogo campos](role-based-authorization-vb/_static/image17.png)](role-based-authorization-vb/_static/image16.png)
...
[![Tél UserGrid GridView muestra información acerca de cada usuario del sistema](role-based-authorization-vb/_static/image20.png)](role-based-authorization-vb/_static/image19.png)
...
[![Madministrar el LoginView específica de la función plantillas mediante el Editor Kolekce RoleGroup.](role-based-authorization-vb/_static/image23.png)](role-based-authorization-vb/_static/image22.png)
...
[![TGil se muestra el mensaje de rol específicos de los administradores](role-based-authorization-vb/_static/image29.png)](role-based-authorization-vb/_static/image28.png)
...
[![Tflujo de trabajo del LoginView Control para determinar qué plantilla que se representarán](role-based-authorization-vb/_static/image32.png)](role-based-authorization-vb/_static/image31.png)
...
[![Cconvertir el CommandField en TemplateField](role-based-authorization-vb/_static/image35.png)](role-based-authorization-vb/_static/image34.png)
...
[![Tpara que no son supervisores y no administradores están ocultos, editar y eliminar botones](role-based-authorization-vb/_static/image38.png)](role-based-authorization-vb/_static/image37.png)
...
[![Wel botón Editar ientras está disponible para los supervisores, se oculta el botón Eliminar](role-based-authorization-vb/_static/image41.png)](role-based-authorization-vb/_static/image40.png)
...
[![TEditar y eliminar botones están disponibles sólo para los administradores](role-based-authorization-vb/_static/image44.png)](role-based-authorization-vb/_static/image43.png)
...
[![Iel contexto de seguridad no está autorizado para ejecutar el método de f, se produce una excepción SecurityException](role-based-authorization-vb/_static/image47.png)](role-based-authorization-vb/_static/image46.png)

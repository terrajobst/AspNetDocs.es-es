...
Para recuperar un valor de propiedad, utilice el formato *$ (PropertyName)* . Por ejemplo, para recuperar el valor de la **ServerName** propiedad, escribiría:

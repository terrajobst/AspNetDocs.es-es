...
description: Cómo crear una aplicación de API Web que use Entity Framework para la persistencia de la base de datos.
ms.author: riande
ms.date: 07/03/2012
...
ms.locfileid: "78449203"
---
# <a name="using-web-api-2-with-entity-framework-6"></a>Usar Web API 2 con Entity Framework 6

> Cómo crear una aplicación de API Web que use Entity Framework para la persistencia de la base de datos.

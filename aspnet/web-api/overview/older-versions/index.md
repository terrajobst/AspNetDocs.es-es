...
---
# <a name="documentation-on-older-versions-of-web-api"></a>Documentación sobre versiones anteriores de Web API

> Documentación sobre versiones anteriores de Web API para ASP.NET 4. x.

...
[Descargar código](https://download.microsoft.com/download/7/2/8/728F8794-E59A-4D18-9A56-7AD2DB05BD9D/MovieApp_VB.zip)
...
**Figura 01**: el cuadro de diálogo nuevo proyecto ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image2.png))
...
**Figura 02**: el cuadro de diálogo crear proyecto de prueba unitaria ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image4.png))
...
**Figura 03**: creación de una base de datos de Microsoft SQL Server ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image6.png))
...
**Figura 04**: la tabla de la base de datos de películas ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image8.png))
...
**Figura 05**: entrada de registros de película ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image10.png))
...
**Figura 06**: generación de un modelo de base de datos con el asistente para Entity Data Model ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image12.png))
...
**Figura 07**: el diseñador de Entity Data Model ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image14.png))
...
**Figura 08**: incorporación de un nuevo controlador ASP.NET MVC ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image16.png))
...
**Enumeración 2: Controllers/HomeController. VB (método de índice modificado)**
...
4. En la lista desplegable **Ver clase de datos** , seleccione el valor *MovieApp. Movie*.
...
**Figura 09**: agregar una vista desde una acción de controlador ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image18.png))
...
**Figura 10**: creación de una nueva vista con el cuadro de diálogo Agregar vista ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image20.png))
...
**Figura 11**: la vista de índice ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image22.png))
...
**Lista 4: Controllers\HomeController.vb (método de creación modificado)**
...
**Figura 12**: adición de la vista de creación ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image24.png))
...
**Figura 13**: creación de un nuevo registro de la base de datos de películas ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image26.png))
...
En primer lugar, es necesario generar el formulario de edición. Este paso es sencillo, ya que Visual Studio generará el formulario de edición para nosotros automáticamente. Abra la clase HomeController. VB en el editor de código de Visual Studio y siga estos pasos:
...
**Figura 14**: adición de la vista de edición ([haga clic para ver la imagen de tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image28.png))
...
**Lista 6 – Controllers\HomeController.vb (editar métodos)**

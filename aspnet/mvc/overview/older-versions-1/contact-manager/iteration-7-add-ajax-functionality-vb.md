...
---
# <a name="iteration-7--add-ajax-functionality-vb"></a>#7 de iteración: agregar funcionalidad de Ajax (VB)
...
[![solo actualizar contactos](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**Figura 01**: actualización solo de contactos ([haga clic para ver la imagen de tamaño completo](iteration-7-add-ajax-functionality-vb/_static/image2.png))
...
**Lista 3-Controllers\ContactController.vb (método de índice)**
...
**Figura 02**: Página de confirmación de eliminación ([haga clic para ver la imagen de tamaño completo](iteration-7-add-ajax-functionality-vb/_static/image4.png))

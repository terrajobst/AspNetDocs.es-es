...
El almacenamiento en caché de resultados proporciona un método muy sencillo de mejorar drásticamente el rendimiento de las aplicaciones ASP.NET MVC. En este tutorial, aprendió a usar el atributo &lt;OutputCache&gt; para almacenar en caché la salida de las acciones del controlador. También aprendió a modificar las propiedades del atributo &lt;OutputCache&gt; como las propiedades Duration y VaryByParam para modificar el modo en que se almacena en caché el contenido. Por último, ha aprendido a definir perfiles de caché en el archivo de configuración Web.

...
Recuerde guardar el Entity Data Model después de realizar una modificación; para ello, haga clic en el botón Guardar (el icono del disquete). En segundo plano, Entity Designer genera un conjunto de clases de Visual Basic .NET. Puede ver estas clases abriendo el archivo MoviesDBModel. Designer. VB desde la ventana Explorador de soluciones.

No modifique el código en el archivo Designer. VB, ya que los cambios se sobrescribirán la próxima vez que use Entity Designer. Si desea ampliar la funcionalidad de las clases de entidad definidas en el archivo Designer. VB, puede crear *clases parciales* en archivos independientes.
...
La vista de la lista 2 contiene un bucle **for each** que recorre en iteración cada registro de película y muestra los valores de las propiedades title y director del registro de la película. Observe que se muestra un vínculo de edición y eliminación junto a cada registro. Además, aparece un vínculo agregar película en la parte inferior de la vista (vea la figura 7).

**Ilustración 7: la vista de índice**

![clip_image014](creating-model-classes-with-the-entity-framework-vb/_static/image7.jpg)

La vista de índice es una *vista con tipo*. La vista de índice tiene una directiva &lt;% @ Page%&gt; que incluye un atributo Inherits. El atributo Inherits convierte la propiedad ViewData. Model en una colección de lista genérica fuertemente tipada de objetos Movie, una lista (de película).
...
**Lista 3: Controllers\HomeController.vb (agregar métodos)**
...
**Lista 4: Controllers\HomeController.vb (editar métodos)**

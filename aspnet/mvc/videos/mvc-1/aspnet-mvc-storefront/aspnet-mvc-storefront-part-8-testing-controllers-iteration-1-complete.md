...
---
# <a name="aspnet-mvc-storefront-part-8-testing-controllers-iteration-1-complete"></a>Escaparate de ASP.NET MVC, parte 8: Controladores de pruebas, iteración 1 completada

por [Rob cónica](https://github.com/robconery)

Rob termina la iteración inicial del sitio y trabaja también en las pruebas del controlador.

[&#9654;Ver vídeo (30 minutos)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-storefront-part-8-testing-controllers-iteration-1-complete)

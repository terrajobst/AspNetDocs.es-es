...
ms.locfileid: "57030682"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="f7bca-102">jQuery Templates Beta 1</span><span class="sxs-lookup"><span data-stu-id="f7bca-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="f7bca-103">El complemento de plantillas de jQuery incluye los siguientes archivos:</span><span class="sxs-lookup"><span data-stu-id="f7bca-103">The jQuery Templates plugin includes the following files:</span></span>

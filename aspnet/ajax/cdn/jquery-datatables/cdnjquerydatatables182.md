...
title: DataTables de jQuery 1.8.2 | Microsoft Docs
...
ms.locfileid: "78454063"
---
# <a name="jquery-datatables-182"></a><span data-ttu-id="05c31-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="05c31-102">jQuery DataTables 1.8.2</span></span>

<span data-ttu-id="05c31-103">Los siguientes archivos para los complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="05c31-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

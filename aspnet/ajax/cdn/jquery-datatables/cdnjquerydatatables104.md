...
ms.locfileid: "57046982"
---
<a name="jquery-datatables-1104"></a><span data-ttu-id="7ff8f-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="7ff8f-102">jQuery DataTables 1.10.4</span></span>
====================
<span data-ttu-id="7ff8f-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ff8f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

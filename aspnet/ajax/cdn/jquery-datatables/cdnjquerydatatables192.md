...
ms.locfileid: "59387638"
---
# <a name="jquery-datatables-192"></a><span data-ttu-id="db4f5-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="db4f5-102">jQuery DataTables 1.9.2</span></span>

<span data-ttu-id="db4f5-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="db4f5-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

...
ms.locfileid: "57027802"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="c8fc8-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="c8fc8-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="c8fc8-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="c8fc8-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

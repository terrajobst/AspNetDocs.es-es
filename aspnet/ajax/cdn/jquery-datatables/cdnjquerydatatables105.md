...
ms.locfileid: "57030692"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="373b7-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="373b7-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="373b7-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="373b7-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

...
ms.locfileid: "59383374"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="3cc26-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="3cc26-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="3cc26-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="3cc26-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

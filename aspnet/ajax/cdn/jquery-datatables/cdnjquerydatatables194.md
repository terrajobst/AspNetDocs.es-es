...
title: DataTables de jQuery 1.9.4 | Microsoft Docs
...
ms.locfileid: "78454051"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="c7bc6-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="c7bc6-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="c7bc6-103">Los siguientes archivos para los complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="c7bc6-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

...
<span data-ttu-id="7ef04-113">**[Archivos de terceros en la red CDN](#Third-Party_Files_on_the_CDN_23)**</span><span class="sxs-lookup"><span data-stu-id="7ef04-113">**[Third-Party Files on the CDN](#Third-Party_Files_on_the_CDN_23)**</span></span>  
...
#### <a name="jquery-version-320"></a><span data-ttu-id="7ef04-203">versión de jQuery 3.2.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-203">jQuery version 3.2.0</span></span>
...
#### <a name="jquery-version-162"></a><span data-ttu-id="7ef04-244">versión de jQuery 1.6.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-244">jQuery version 1.6.2</span></span>
...
#### <a name="jquery-version-144"></a><span data-ttu-id="7ef04-250">versión de jQuery 1.4.4</span><span class="sxs-lookup"><span data-stu-id="7ef04-250">jQuery version 1.4.4</span></span>
...
- [<span data-ttu-id="7ef04-283">jQuery UI 1.8.23</span><span class="sxs-lookup"><span data-stu-id="7ef04-283">jQuery UI 1.8.23</span></span>](jquery-ui/cdnjqueryui1823.md "jQuery UI 1.8.23 en la red CDN de Microsoft Ajax")
...
- [<span data-ttu-id="7ef04-321">1.6 de validación de jQuery</span><span class="sxs-lookup"><span data-stu-id="7ef04-321">jQuery Validate 1.6</span></span>](jquery-validate/cdnjqueryvalidate16.md "1.6 de validación de jQuery")
...
- [<span data-ttu-id="7ef04-341">jQuery Mobile 1.0 RC 1</span><span class="sxs-lookup"><span data-stu-id="7ef04-341">jQuery Mobile 1.0 RC 1</span></span>](jquery-mobile/cdnjquerymobile10rc1.md "jQuery Mobile 1.0 RC1 en la red CDN de Microsoft Ajax")
...
<span data-ttu-id="7ef04-367">Las siguientes versiones de [JSHint](http://www.jshint.com "JSHint") se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-367">The following releases of [JSHint](http://www.jshint.com "JSHint") are hosted on the CDN:</span></span>
...
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js
    ...
    - <span data-ttu-id="7ef04-375">Reemplace "{-código de referencia cultural}" con el código de la referencia cultural deseada, por ejemplo, Microsoft globalize.culture.en GB.js== archivos en la red CDN == estas bibliotecas se cargaron por Microsoft.</span><span class="sxs-lookup"><span data-stu-id="7ef04-375">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="7ef04-376">Responder a las versiones en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-376">Respond Releases on the CDN</span></span>

<span data-ttu-id="7ef04-377">Las siguientes versiones de [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") Respond se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-377">The following releases of [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") Respond are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="7ef04-378">Responder versión 1.4.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-378">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="7ef04-379">Versión 1.4.1 de responder</span><span class="sxs-lookup"><span data-stu-id="7ef04-379">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="7ef04-380">Responder a la versión 1.4.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-380">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="7ef04-381">Responder a la versión 1.3.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-381">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="7ef04-382">Responder a la versión 1.2.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-382">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="7ef04-383">Versiones de bootstrap en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-383">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="7ef04-384">Las siguientes versiones de [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-384">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-431"></a><span data-ttu-id="7ef04-385">Bootstrap versión 4.3.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-385">Bootstrap version 4.3.1</span></span>
...
#### <a name="bootstrap-version-421"></a><span data-ttu-id="7ef04-386">Versión 4.2.1 de bootstrap</span><span class="sxs-lookup"><span data-stu-id="7ef04-386">Bootstrap version 4.2.1</span></span>
...
#### <a name="bootstrap-version-411"></a><span data-ttu-id="7ef04-387">Versión de bootstrap 4.1.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-387">Bootstrap version 4.1.1</span></span>
...
#### <a name="bootstrap-version-400"></a><span data-ttu-id="7ef04-388">Bootstrap versión 4.0.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-388">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-341"></a><span data-ttu-id="7ef04-389">Versión de bootstrap 3.4.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-389">Bootstrap version 3.4.1</span></span>
...
#### <a name="bootstrap-version-340"></a><span data-ttu-id="7ef04-390">Bootstrap versión 3.4.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-390">Bootstrap version 3.4.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="7ef04-391">Versión de bootstrap 3.3.7</span><span class="sxs-lookup"><span data-stu-id="7ef04-391">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="7ef04-392">Versión de bootstrap 3.3.6</span><span class="sxs-lookup"><span data-stu-id="7ef04-392">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="7ef04-393">Versión de bootstrap 3.3.5</span><span class="sxs-lookup"><span data-stu-id="7ef04-393">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="7ef04-394">Versión de bootstrap 3.3.4</span><span class="sxs-lookup"><span data-stu-id="7ef04-394">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="7ef04-395">Versión de bootstrap 3.3.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-395">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="7ef04-396">Versión de bootstrap 3.3.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-396">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="7ef04-397">Bootstrap versión 3.3.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-397">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="7ef04-398">Versión de bootstrap 3.2.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-398">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="7ef04-399">Bootstrap versión 3.1.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-399">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="7ef04-400">Bootstrap versión 3.1.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-400">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="7ef04-401">Versión de bootstrap 3.0.3</span><span class="sxs-lookup"><span data-stu-id="7ef04-401">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="7ef04-402">Versión de bootstrap 3.0.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-402">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="7ef04-403">Bootstrap versión 3.0.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-403">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="7ef04-404">Bootstrap versión 3.0.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-404">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="7ef04-405">Versión 2.3.2 de bootstrap</span><span class="sxs-lookup"><span data-stu-id="7ef04-405">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="7ef04-406">Bootstrap versión 2.3.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-406">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="7ef04-407">Versiones de bootstrap TouchCarousel en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-407">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="7ef04-408">Las siguientes versiones de [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-408">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="7ef04-409">Bootstrap TouchCarousel versión 0.8.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-409">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="7ef04-410">Versiones de hammer.js en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-410">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="7ef04-411">Las siguientes versiones de [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js versiones se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-411">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="7ef04-412">Hammer.js versión 2.0.4</span><span class="sxs-lookup"><span data-stu-id="7ef04-412">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="7ef04-413">Formularios Web Forms ASP.NET y las versiones de Ajax en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-413">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="7ef04-414">Las siguientes versiones de la biblioteca de Ajax de ASP.NET se hospedan en la red CDN.</span><span class="sxs-lookup"><span data-stu-id="7ef04-414">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="7ef04-415">Haga clic en cada vínculo para ver la lista real de archivos.</span><span class="sxs-lookup"><span data-stu-id="7ef04-415">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="7ef04-416">Versión de formularios Web Forms ASP.NET y Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-416">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "formularios Web Forms ASP.NET y Ajax 4.5.2")
- [<span data-ttu-id="7ef04-417">Versión de formularios Web Forms ASP.NET y Ajax 4</span><span class="sxs-lookup"><span data-stu-id="7ef04-417">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "formularios Web Forms ASP.NET y Ajax 4")
- [<span data-ttu-id="7ef04-418">Ajax de ASP.NET versión 3.5</span><span class="sxs-lookup"><span data-stu-id="7ef04-418">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "Ajax de ASP.NET 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="7ef04-419">ASP.NET MVC se libera en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-419">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="7ef04-420">Los siguientes archivos JavaScript de ASP.NET MVC se hospedan en esta red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-420">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="7ef04-421">ASP.NET MVC 5.2.3</span><span class="sxs-lookup"><span data-stu-id="7ef04-421">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="7ef04-422">ASP.NET MVC 5.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-422">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="7ef04-423">ASP.NET MVC 5.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-423">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="7ef04-424">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-424">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="7ef04-425">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-425">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="7ef04-426">ASP.NET MVC 2.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-426">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="7ef04-427">ASP.NET MVC 1.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-427">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="7ef04-428">ASP.NET SignalR se libera en la red CDN</span><span class="sxs-lookup"><span data-stu-id="7ef04-428">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="7ef04-429">Los siguientes archivos JavaScript SignalR de ASP.NET se hospedan en esta red CDN:</span><span class="sxs-lookup"><span data-stu-id="7ef04-429">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="7ef04-430">ASP.NET SignalR 2.2.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-430">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="7ef04-431">ASP.NET SignalR 2.2.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-431">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="7ef04-432">ASP.NET SignalR 2.2.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-432">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="7ef04-433">ASP.NET SignalR 2.1.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-433">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="7ef04-434">ASP.NET SignalR 2.0.3</span><span class="sxs-lookup"><span data-stu-id="7ef04-434">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="7ef04-435">ASP.NET SignalR 2.0.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-435">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="7ef04-436">ASP.NET SignalR 2.0.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-436">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="7ef04-437">ASP.NET SignalR 2.0.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-437">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="7ef04-438">ASP.NET SignalR 1.1.3</span><span class="sxs-lookup"><span data-stu-id="7ef04-438">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="7ef04-439">ASP.NET SignalR 1.1.2</span><span class="sxs-lookup"><span data-stu-id="7ef04-439">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="7ef04-440">ASP.NET SignalR 1.1.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-440">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="7ef04-441">ASP.NET SignalR 1.1.0</span><span class="sxs-lookup"><span data-stu-id="7ef04-441">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="7ef04-442">ASP.NET SignalR 1.0.1</span><span class="sxs-lookup"><span data-stu-id="7ef04-442">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="7ef04-443">Para obtener información acerca de los términos de uso de la red CDN, consulte [Microsoft Ajax CDN términos de uso](https://www.asp.net/terms-of-use "Ajax CDN términos de uso de Microsoft").</span><span class="sxs-lookup"><span data-stu-id="7ef04-443">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>

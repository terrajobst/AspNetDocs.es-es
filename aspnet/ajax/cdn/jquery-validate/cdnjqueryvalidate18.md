...
ms.locfileid: "59378321"
---
# <a name="jqueryvalidate-version-18"></a><span data-ttu-id="53fb4-102">Versión 1.8 de jquery.validate</span><span class="sxs-lookup"><span data-stu-id="53fb4-102">jquery.validate version 1.8</span></span>

<span data-ttu-id="53fb4-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="53fb4-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="53fb4-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="53fb4-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>

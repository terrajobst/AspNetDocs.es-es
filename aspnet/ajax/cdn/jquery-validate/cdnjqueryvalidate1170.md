...
---
<a name="jquery-validation-1170"></a><span data-ttu-id="5cb61-102">1.17.0 de validación de jQuery</span><span class="sxs-lookup"><span data-stu-id="5cb61-102">jQuery Validation 1.17.0</span></span>
====================
<span data-ttu-id="5cb61-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="5cb61-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="5cb61-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="5cb61-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>

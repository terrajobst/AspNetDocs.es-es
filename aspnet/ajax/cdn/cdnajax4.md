...
ms.locfileid: "78454171"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="d656f-102">Formularios Web Forms de ASP.NET y Ajax 4</span><span class="sxs-lookup"><span data-stu-id="d656f-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="d656f-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="d656f-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="d656f-104">Nota: los scripts de globalización, como fr-FR. js, se pueden encontrar en la siguiente carpeta:</span><span class="sxs-lookup"><span data-stu-id="d656f-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>

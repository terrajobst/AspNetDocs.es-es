...
ms.locfileid: "57045472"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="38f88-102">Formularios ASP.NET Web Forms y Ajax 4</span><span class="sxs-lookup"><span data-stu-id="38f88-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="38f88-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="38f88-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="38f88-104">Nota: Las secuencias de comandos de globalización, por ejemplo, fr-FR.js, pueden encontrarse en la siguiente carpeta:</span><span class="sxs-lookup"><span data-stu-id="38f88-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>

...
Este repositorio contiene la documentación conceptual de 4.x ASP.NET hospedada en [docs.microsoft.com/aspnet](https://docs.microsoft.com/aspnet). Vea la [Guía de colaboración](CONTRIBUTING.md) y la [lista de problemas](https://github.com/aspnet/AspNetDocs/issues) si quiere ayudar.

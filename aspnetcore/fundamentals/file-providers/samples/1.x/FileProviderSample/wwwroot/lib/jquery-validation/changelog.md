...
## <a name="additional"></a>Adicional
  * Refinar los algoritmos cifES y nieES. Cierra #1826

## <a name="build"></a>Compilar
  * Incluir versión minimizada en el paquete de NPM
  * Dependencias de desarrollo de rugosidad a versiones más recientes

## <a name="core"></a>Principal
  * Agregar enlace para entrada con el tipo de botón. Cierra nº 1891
  * Admitir jquery3. Cierra nº 1866
  * Cambiar alias de jQuery "expr [":"]" a "expr.pseudos"

## <a name="localisation"></a>Localización
  * Agregar traducción en urdu. Cierra nº 1873.

## <a name="localization"></a>Localización
  * Se corrigió la extensión de archivo incorrecta para la traducción de az. Cierra nº 1890.
  * Se ha agregado la traducción que falta en pt-BR (cierra nº 1897)
  * Se corrigió el error ortográfico en el archivo de idioma árabe.

## <a name="tests"></a>Pruebas
  * Actualizar QUnit a 2.0.

## <a name="umd"></a>UMD
  * Mejor compatibilidad para CommonJS.

<a name="1151--2016-07-22"></a>1.15.1 / 2016-07-22
==================

## <a name="additional"></a>Adicional
  * Corregir validación de tipo mime múltiple
  * IBAN requieren al menos 5 caracteres (cierra nº 1797, corrige nº 1674)
  * Corregir referencia de jQuery notEqualTo

## <a name="core"></a>Principal
  * Se agregó la prueba con errores para nº 1805
  * Corregir validación de grupo con 3 y más campos
  * Corregir las regresiones introducidas en nº 1644 y nº 1657 (cierra nº 1800)
  * Actualizar validación de paso para controlar correctamente los puntos flotantes
  * Corregir el error al llamar a $.fn.rules() en un elemento que no es un formulario
  * Llamar a `errorPlacement` en el ámbito del validador
  * Se corrigió un problema con elementos contenteditable en formularios donde los eventos para la validación de entrada única produciría excepciones

## <a name="demo"></a>Demostración
  * Agregar vínculos a demostraciones de Bootstrap y Semantic-UI en index.html
  * Usar `.on()` en lugar de `.validateDelegate()`

## <a name="localization"></a>Localización
  * Se agregó el idioma azerí

## <a name="tests"></a>Pruebas
  * Se agregaron pruebas unitarias de regresión para PR nº 1760

<a name="1150--2016-02-24"></a>1.15.0 / 2016-02-24
==================

## <a name="all"></a>Todas
  * Problemas de estilo de código corregidos

## <a name="core"></a>Principal
  * `resetForm` también debe quitar la clase `valid` de elementos.
  * Anulación del resaltado del campo si ya está resaltado cuando se usa la regla remota.
  * Enlazar el evento `blur` una sola vez en la regla `equalTo`
  * Error corregido al llamar a .rules() en el conjunto jquery vacío.
  * Corregir control de mensaje de error con grupos de entrada.
  * Corregir TypeError en `showLabel` al usar la configuración `groups`
  * Agregar una forma de pasar el nombre de método a remoto
  * La validación no se puede desencadenar cuando el siguiente campo ya está relleno (corrige nº 1508)
  * La regla requerida tienen prioridad sobre las reglas de número y dígitos
  * Error oculto, pero la clase de errores de entrada no quitada
  * La validación remota utiliza mensajes de error incorrectos
  * Se corrigió el resaltado con validación remota.
  * Se corrigió el selector `:filled` para varios elementos de selección.
  * Se agregó la referencia de documento a jQuery.validator.methods
  * Trasladar el procesamiento de mensajes de `formatAndAdd` a `defaultMessage`
  * ErrorList debería contener solo los errores que debe
  * Extraer el nombre de archivo sin incluir "C:\fakepath\"
  * Compatibilidad con atributos de paso HTML5. Corrige nº 1295
  * Se agregó compatibilidad para clase "pendiente" en las solicitudes pendientes
  * Normalizador agregado (nº 1602)
  * Dividir método `creditcard`
  * Escapar errorID para su uso en la expresión regular, no para compilar aria-describedby
  * Escapar las comillas simples en los nombres evitando que se produzca un error Sizzle
  * En lugar de usar el valor del campo de validación para omitir la llamada api, utilizar el objeto de datos serializados de la solicitud
  * Agregar compatibilidad con etiquetas contentEditable

## <a name="additional"></a>Adicional
  * BIC: permitir los dígitos 1 a 9 en segundo lugar de la ubicación
  * La expresión regular del método de aceptación se debe escapar correctamente.
  * Comprobación de no distinción entre mayúsculas y minúsculas para BIC
  * PostalCodeCA correcto para excluir combinaciones no válidas
  * Hacer que el método postalCodeCA sea más flexible

## <a name="localization"></a>Localización
  * Localización en macedonio agregada.
  * Mensaje de patrón ausente agregado en polaco (adamwojtkiewicz)
  * Traducción en persa del mensaje mín./máx. corregida.
  * Mensajes actualizados _sk.js
  * Traducción en malayo corregida
  * Mensajes incluidos desde métodos adicionales
  * Mejorar la traducción en pt_BR y corregir un error ortográfico en la clave 'cifES'.
